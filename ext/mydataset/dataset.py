...
tokenizer = BertTokenizerFast.from_pretrained("./luhua")
...
#             answers = [answer["text"].strip() for answer in entry.get("answers", [])]
#             context = entry['context'].strip()
#             title = ""
#             answer_starts = [answer["answer_start"] for answer in entry['answers']]
#             is_impossible = False
#             if "is_impossible" in entry.keys():

...
from mydataset.dataset import MrcDataset
from mydataset.dataset import collate_fn
...
def evaluate(args, eval_iter, model, prefix):
    ...
    if prefix == "eval":
        ...
        # print(type(df["answers"]),type(  df["answers_pre"]))
...
def out (args, eval_iter, model, prefix):
    logger.info("***** Running Evalation *****")
